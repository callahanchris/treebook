...
class PicturesControllerTest < ActionController::TestCase
  ...
  test "should create activity on create" do
    sign_in users(:chris)
    assert_difference 'Activity.count', 1 do
      post :create, @default_params.merge(id: @picture, picture: { caption: @picture.caption, description: @picture.description })
    end
  end
  ...
  test "should create activity on destroy" do
    sign_in users(:chris)
    assert_difference 'Activity.count', 1 do
      post :destroy, @default_params.merge(id: @picture)
    end
  end
end
